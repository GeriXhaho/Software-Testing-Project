...
import Directories.Helpers.BillMock;
import Directories.Helpers.BookMock;
import Directories.Roles.UserInterface;
import Directories.Roles.UserMock;
...
class BillControllerTest {
    ...
    void setDate() {
        ...
        Date date =  cal.getTime();
        assertEquals(date.toString(), billControllerTest.setDate(10, 1, 2000).toString());
    }
